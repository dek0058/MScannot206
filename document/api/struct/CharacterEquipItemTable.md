# [CharacterEquipItemTable](../../../RootDesk/MyDesk/Source/Table/CharacterEquipItemTable.mlua)

자동 생성된 테이블 입니다. 수정하지 마세요 (Derivative: CharacterEquipItem)
...
<table style="width: 100%; border-collapse: collapse; border: 1px solid #ccc; margin-bottom: 16px;">
    <tbody>
        <tr>
            <td style="background-color: #f0f0f0; padding: 10px 5px; text-align: left; vertical-align: top;">
                <span style="color: #3167ad;">CharacterEquipItemRecord</span> <span style="font-weight: bold;">GetRecord</span>(<span style="color: #3167ad;">string</span> key)
            </td>
        </tr>
        <tr>
            <td style="background-color: #fff; padding: 10px 5px; text-align: left; vertical-align: top;">
